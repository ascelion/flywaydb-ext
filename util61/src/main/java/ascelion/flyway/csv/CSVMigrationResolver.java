...
public final class CSVMigrationResolver extends CSVMigrationResolverBase<LoadableResource> {
	...
	@Override
	protected CSVResolvedMigrationBase<LoadableResource> newMigration(Configuration cf, LoadableResource res, MigrationVersion version,
			String table, String desc) {
